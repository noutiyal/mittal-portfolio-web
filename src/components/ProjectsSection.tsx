...
const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ["Laravel", "jQuery", "MySQL", "AJAX"],
  },
  {
    id: 3,
    name: "QuicLoans",
    description: "Loan management system with automated approval workflows, payment tracking, and client portal.",
    technologies: ["PHP", "Laravel", "JavaScript", "MySQL"],
  },
  {
    id: 4,
    name: "Blissful",
    description: "E-commerce platform with product management, secure payment processing, and order fulfillment.",
    technologies: ["PHP", "Laravel", "Bootstrap", "MySQL", "jQuery"],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    technologies: ["Laravel", "JavaScript", "MySQL", "AJAX"],
  },
  {
    id: 7,
    name: "SocialBlaze",
